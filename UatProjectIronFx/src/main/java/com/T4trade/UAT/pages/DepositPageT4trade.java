...
public class DepositPageT4trade {

		private WebDriver driver;
		 public DepositPageT4trade(WebDriver driver) {
		        this.driver = driver;
		    }
		// 🔹 Locators
	
		private By cardTypeField = By.xpath("/html/body/div[1]/div[1]/div/div[3]/section/div/div/form/div/div[1]/div[5]/select");
		private By currencyField = By.xpath("/html/body/div[1]/div[1]/div/div[3]/section/div/div/form/div/div[1]/div[6]/select");
